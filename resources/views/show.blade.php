                ...
                <div class="flex flex-wrap items-center mt-8">
                    ...
                    <div class="flex items-center mt-4 space-x-4 sm:mt-0 sm:ml-12">
                        <div class="flex items-center justify-center w-8 h-8 bg-gray-800 rounded-full">
                            <a href="{{ $game->socials["website"] }}" class="hover:text-gray-400">
                        ...
                        <div class="flex items-center justify-center w-8 h-8 bg-gray-800 rounded-full">
                            <a href="{{ $game->socials["instagram"] }}" class="hover:text-gray-400">
                        ...
                        <div class="flex items-center justify-center w-8 h-8 bg-gray-800 rounded-full">
                            <a href="{{ $game->socials["twitter"] }}" class="hover:text-gray-400">
                        ...
                        <div class="flex items-center justify-center w-8 h-8 bg-gray-800 rounded-full">
                            <a href="{{ $game->socials["facebook"] }}" class="hover:text-gray-400">
            ...
            <div class="text-sm similar-games grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                @foreach ($game->similarGames as $similarGame)
                    <div class="mt-8 game">
                        ...
                        <a href="{{ $similarGame->slug }}" class="block mt-8 text-base font-semibold leading-tight hover:text-gray-400">
                            {{ $similarGame->name }}
                        </a>
